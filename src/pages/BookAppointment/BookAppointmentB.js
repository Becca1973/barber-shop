    ...
    return (
      <div className="flex flex-col gap-2 w-full max-w-xl">
        {slots.map((slot) => {
          ...
          const label = `${moment(slot, "HH:mm").format("hh:mm A")} - ${moment(
            slot,
            "HH:mm"
          )
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                {isBooked && <span className="text-sm">Booked</span>}
              </div>
            </button>
          );
        })}
    ...
    barber && (
      <div className="bg-white p-2 h-auto">
        ...
        <div className="flex flex-col gap-1 my-2">
          ...
          <div className="my-2">{date && getSlotsData()}</div>
...
export default BookAppointmentB;
